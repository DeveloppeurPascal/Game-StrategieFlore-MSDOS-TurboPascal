# Stratégie Flore - Turbo Pascal - MS-Dos - 1992

[This page in English.](README.md)

Stratégie Flore est ma version PC d'[un jeu de 1984](http://jeuxvideos8090.free.fr/index.php?Id_Soft=400) auquel j'avais dû jouer sur micro ordinateurs [Thomson TO7-70 ou TO9](https://fr.wikipedia.org/wiki/Thomson_TO7/70). Je ne me souviens plus trop du principe de jeu mais ça doit probablement être un match-3 d'après les captures d'écran. Il faudrait relire les codes sources pour s'en assurer.

J'utilisais le format d'images PPP sur ce jeu (et d'autres). Ne cherchez pas trop, c'est un truc à moi. J'ouvrirai les codes sources de mon logiciel de dessin un jour.

Développé en [Turbo Pascal](https://fr.wikipedia.org/wiki/Turbo_Pascal) en 1992 pour fonctionner sous MS-Dos en mode VGA pour avoir quelques couleurs à l'écran.
