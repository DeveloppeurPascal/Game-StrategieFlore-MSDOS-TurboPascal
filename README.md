# Flora Strategy - Turbo Pascal - MS-Dos - 1992

[Cette page en français.](LISEZMOI.md)

Stratégie Flore is my PC version of [a 1984 game](http://jeuxvideos8090.free.fr/index.php?Id_Soft=400) I had to play on [Thomson TO7-70 or TO9](https://fr.wikipedia.org/wiki/Thomson_TO7/70) microcomputers. I don't really remember the gameplay, but it's probably a match-3 from the screenshots. You'd have to reread the source codes to be sure.

I used the PPP image format on this game (and others). Don't look too hard, it's my own thing. I'll open the source codes for my drawing software one day.

Developed in [Turbo Pascal](https://en.wikipedia.org/wiki/Turbo_Pascal) in 1992 to run under MS-Dos in VGA mode to get some color on the screen.
